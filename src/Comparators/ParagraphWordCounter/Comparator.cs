...
namespace DocumentPlagiarismChecker.Comparators.ParagraphWordCounter
{
    ...
    {  
        ...
        public override ComparatorMatchingScore Run(){     
            ...
            ExcludeSampleExactMatches(); //Comentario ExcludeSmapleMatches 
            ExcludeSamplePartialMatches(this.Left, 0.70f);  //TODO: el valor del umbral debe obtenerse de la configuración; mira si se puede quitar
            ExcludeSamplePartialMatches(this.Right, 0.70f);  //TODO: valor del umbral debe obtenerse de la configuración; mira si se puede quitar
